...
from app.celery_workflows import chain_integers_multiplication, group_integers_multiplication, \
    chord_integers_multiplication
...
async def post_chain_integers_multiplication(
        ...
        nb_chains: int = Query(
            ...,
            description="How many chain multiplication by 2 do you want ?")
) -> int:
...
async def post_group_integers_multiplication(
        ...
        nb_groups: int = Query(
            ...,
            description="How many single multiplication by 2 do you want ?")
) -> int:
...
async def post_chord_integers_multiplication(
        ...
        nb_groups: int = Query(
            ...,
            description="How many single multiplication by 2 do you want before to sum all of them ?")
) -> int:
